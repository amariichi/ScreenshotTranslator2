...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.system_prompt = (
            ...
            " Preserve numbers, dates, prices, percentages, units, and proper nouns accurately."
            " Keep numeric suffixes and units consistent; when present, bn means billion and tn means trillion."
            " Keep chart labels, table entries, captions, and prose separate."
